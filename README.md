...
- **Onboarding & docs:** Built a documentation ecosystem and review process → **new‑hire ramp reduced ~2 weeks → 3 days**.
- **Mentoring:** Ongoing 1:1 coaching; guided an **Associate SQE → Lead Software Engineer**.
- **Copilot at scale:** Team‑level Copilot Instructions, CLI‑based code comprehension/flowcharts for legacy C, agent‑assisted **.NET 6 → .NET 8** upgrades, and prompt packs that offload **~80%** of repeatable tasks (code + KQL + pipelines + Bicep + docs).
